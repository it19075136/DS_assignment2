...
export const deleteProduct=(productId)=>(dispatch)=>{
    axios.delete("http://localhost:5000/api/products/delete/"+productId).then((res)=>{
        dispatch({})
    }).catch((err)=>{
        console.log(err);
    })
...
export const updateProduct=product=>dispatch=>{
    axios.update("http://localhost:5000/api/products/update",product).then((res)=>{//product include _id but not  include in product module
